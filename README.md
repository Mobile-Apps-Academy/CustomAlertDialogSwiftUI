...
A custom modular alert dialog, Developed using SwiftUI.
...
1. Clone the repo
   ```sh
   git clone https://github.com/Mobile-Apps-Academy/CustomAlertDialogSwiftUI.git
   ```
### Usage

1. How to create the dialog view
